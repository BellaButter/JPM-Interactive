    ...
    <main className="relative bg-white overflow-x-hidden w-full max-w-[100vw] min-w-0">
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 w-[100vw] left-1/2 -translate-x-1/2" aria-hidden style={{ maxWidth: "100vw" }}>
          <div className="absolute -top-40 -left-40 w-[700px] h-[700px] rounded-full bg-gradient-to-br from-blue-400/15 via-violet-400/10 to-transparent blur-3xl" />
          <div className="absolute -bottom-32 -right-32 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-violet-400/15 via-cyan-400/10 to-transparent blur-3xl" />
        </div>
      ...
      <div className="w-full flex justify-center" style={LAYOUT_PADDING}>
        <div className="w-full max-w-[1600px] flex flex-col">
          ...
          <section className="w-full relative overflow-hidden rounded-3xl" style={{ ...SECTION_MARGIN, padding: "clamp(2rem, 5vw, 3rem)" }}>
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#6B9FF7]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" aria-hidden />
            <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#8B5CF6]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" aria-hidden />
          ...
          <section className="w-full relative overflow-hidden rounded-3xl" style={{ ...SECTION_MARGIN, padding: "clamp(2rem, 5vw, 3rem)" }}>
            ...
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#6B9FF7]/10 rounded-full blur-3xl pointer-events-none" aria-hidden />
            <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-[#8B5CF6]/10 rounded-full blur-3xl pointer-events-none" aria-hidden />
            <div className="relative z-10">
              <motion.div {...fadeUp(0)} className="flex items-center gap-4" style={{ marginBottom: "3rem" }}>
                <motion.div
