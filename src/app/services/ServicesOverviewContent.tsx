            ...
            <div className="relative flex flex-col flex-1 min-h-0" style={{ padding: "clamp(3.25rem, 8vw, 4rem)" }}>
                ...
                <div className="mt-auto" style={{ paddingTop: "2rem" }}>
                    ...
                    >
                        ...
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={cfg.iconStroke} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="w-full flex justify-center" style={LAYOUT_PADDING}>
                <div className="w-full max-w-[1600px] flex flex-col">
                    ...
                    <section className="relative w-full" style={{ ...SECTION_MARGIN, paddingTop: "clamp(2rem, 6vw, 3.5rem)", paddingBottom: "clamp(2rem, 6vw, 3.5rem)" }}>
                        ...
                        >
                            {/* Orbs inside banner */}
                            <div className="pointer-events-none absolute top-0 left-0 w-64 h-64 rounded-full bg-white/8 blur-3xl -translate-y-1/2 -translate-x-1/2" aria-hidden />
                            <div className="pointer-events-none absolute bottom-0 right-0 w-64 h-64 rounded-full bg-white/8 blur-3xl translate-y-1/2 translate-x-1/2" aria-hidden />
