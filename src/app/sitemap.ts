...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const staticPaths = ["", "/about", "/contact", "/case-studies", "/content", "/industries", "/services", "/services/interactive-installation", "/services/immersive-experience", "/services/multimedia-systems"];
