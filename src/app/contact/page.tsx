                            ...
                            <div style={{ paddingTop: "1.5rem" }} className="border-t-2 border-[var(--color-dark-border)]">
                                ...
                                <div className="flex flex-wrap items-center gap-4 ml-16" style={{ marginTop: "1rem" }}>
                                    <motion.a
                                        ...
                                        aria-label="LINE @jpmmediaspace"
                                    >
                                        <span className="w-12 h-12 shrink-0 bg-[#00B900]/10 border-2 border-[#00B900]/40 rounded-full flex items-center justify-center group-hover:bg-[#00B900] group-hover:border-[#00B900] transition-all text-[#00B900] group-hover:text-white shadow-md">
                                        ...
                                        <span className="text-[var(--color-text-primary)] group-hover:text-[#00B900] transition-colors text-xl md:text-2xl font-bold">
                                            LINE: @jpmmediaspace
                                        </span>
                                    </motion.a>
                                </div>
